...
res = QF.ResolutionDataModel(grpfilename = grpfilename, energy_range = 0.3, q_index = [1,3,5], neutron_e0 = 3.32, max_n_gauss = 4, mirror = 'off')
...
energy_range = [(-5,2)]*7 + [(-4,2)]*3 + [(-3,2)]*10, neutron_e0 = 3.32)
